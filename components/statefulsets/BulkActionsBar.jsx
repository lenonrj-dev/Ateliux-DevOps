// file: components/statefulsets/BulkActionsBar.jsx
"use client";

import { RotateCcw, Trash2, Settings2, SlidersHorizontal, X } from "lucide-react";
import { useCallback, useMemo, useState } from "react";
import { motion } from "framer-motion";

export default function BulkActionsBar({ count, onClear, onRestart, onDelete, onUpdateStrategy, onScale }) {
  const [loading, setLoading] = useState(null); // 'restart' | 'scale' | 'update' | 'delete' | null
  ...
  return (
    <div
      ...
      role="region"
      aria-label="Ações em massa de StatefulSets"
    >
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Btn
          onClick={() => run("update", onUpdateStrategy)}
          icon={Settings2}
          loadingKey="update"
        >
